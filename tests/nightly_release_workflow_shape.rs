...
/// A workflow file under `.github/workflows/`, resolved relative to this crate. `dig-installer` is a
...
/// dig_ecosystem#698 / dig-installer#80: the `stable` job's `if:` used to accept
