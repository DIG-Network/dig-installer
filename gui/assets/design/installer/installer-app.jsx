  ...
  return (
    <div className="fade-key">
      ...
      <div className="meta-chips">
        ...
        <span className="chip"><span className="k">license</span>GPL-2.0</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="fade-key">
      ...
      <div className="license">
        ...
        <p>1. GRANT. DigStore is free software: under the GNU General Public License, version 2 (the "License"), you may use, study, share and modify the DigStore command-line interface and host runtime (the "Software"). When you distribute the Software or derivative works, you must pass on the same freedoms under the GPLv2 and make the corresponding source available.</p>
